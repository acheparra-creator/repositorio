...
claude-ads/
  ...
  skills/                            # 20 specialized sub-skills (v2.4.1)
    ...
    ads-carousel/SKILL.md         # NEW v2.4.1 — multi-card carousel builder (Meta + LinkedIn)
...
| `/ads carousel` | **NEW v2.4.1** — multi-card carousel builder for Meta + LinkedIn |
...
This project uses the [AI Software Architect](https://github.com/codenamev/ai-software-architect) framework for architectural reviews and decision documentation.

| Command | Purpose |
|---------|---------|
| `Setup ai-software-architect` | Initialize framework (already done) |
| `List architecture members` | View the specialized review team |
| `Create ADR for [topic]` | Document an architectural decision |
| `Start architecture review for [feature]` | Trigger a full team review |
| `Ask [specialist] to review [component]` | Get a focused specialist review |
| `What's our architecture status?` | Check framework setup and recent activity |

Documentation lives in [`.architecture/`](.architecture/) — commit it alongside code.
